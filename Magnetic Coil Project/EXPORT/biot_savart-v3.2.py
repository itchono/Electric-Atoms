...
def plot_xPlane(targetVolume,BOX_SIZE,VOLUME_RESOLUTION,x=0,plot=[True,True,True],levelNum = 250):
    ...
    if plot[0] == True:
        ...
        title = "B_x at X = " + str(x)
        xlabel = "Y"
        ylabel = "Z"

        plotter(Y,Z,B_x,xlabel,ylabel,title)
    ...
    if plot[1] == True:
        ...
        title = "B_y at X = " + str(x)
        xlabel = "Y"
        ylabel = "Z"

        plotter(Y,Z,B_y,xlabel,ylabel,title)

    #plot B_z
    if plot[2] == True:
        B_z= targetVolume[x,:,:,2].T
        
        title = "B_z at X = " + str(x)
        xlabel = "Y"
        ylabel = "Z"

        plotter(Y,Z,B_z,xlabel,ylabel,title)


def plot_yPlane(targetVolume,BOX_SIZE,VOLUME_RESOLUTION,y=0,plot=[True,True,True],levelNum = 250):
    ...
    if plot[0] == True:
        ...
        title = "B_x at Y = " + str(y)
        xlabel = "X"
        ylabel = "Z"

        plotter(X,Z,B_x,xlabel,ylabel,title)
    ...
    if plot[1] == True:
        ...
        title = "B_y at Y = " + str(y)
        xlabel = "X"
        ylabel = "Z"

        plotter(X,Z,B_y,xlabel,ylabel,title)
    ...
    if plot[2] == True:
        ...
        title = "B_z at Y = " + str(y)
        xlabel = "X"
        ylabel = "Z"

        plotter(X,Z,B_z,xlabel,ylabel,title)


def plot_zPlane(targetVolume,BOX_SIZE,VOLUME_RESOLUTION,z=0,plot=[True,True,True],levelNum = 250):
    X = np.arange(0,BOX_SIZE[0]+1,VOLUME_RESOLUTION)
    Y = np.arange(0,BOX_SIZE[1]+1,VOLUME_RESOLUTION)
    ...
    if plot[0] == True:
        ...
        plotter(X,Y,B_x,xlabel,ylabel,title)
    ...
    if plot[1] == True:
        ...
        plotter(X,Y,B_y,xlabel,ylabel,title)
    ...
    if plot[2] == True:
        ...
        plotter(X,Y,B_z,xlabel,ylabel,title)

        
def plotter(X,Y,B,xlabel,ylabel,title):
    fig, ax = plt.subplots()    
    CS = ax.contourf(X,Y,B,cmap=cm.magma,levels=50)      # more levels looks better
                                                          # use cm.Spectral to examine variations from uniformity
...
def test():
    ...
    # plot_xPlane(targetVolume,BOX_SIZE,VOLUME_RESOLUTION,x=0,plot=[True,True,True],levelNum = 250)
    # plot_yPlane(targetVolume,BOX_SIZE,VOLUME_RESOLUTION,y=0,plot=[True,True,True],levelNum = 250)
    plot_zPlane(targetVolume,BOX_SIZE,VOLUME_RESOLUTION,z=3,plot=[True,True,True],levelNum = 250)
